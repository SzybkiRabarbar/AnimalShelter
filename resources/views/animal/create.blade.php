        ...
        <form method="POST" action="{{ route('animal.store') }}" enctype="multipart/form-data">
            ...
            <div class="mt-4">
                ...
                <label for="is_male" class="inline-flex items-center">
                    <input id="is_male" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_male" value="1" @checked(old('is_male'))>
            ...
            <div class="mt-4">
                ...
                <textarea id="history" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="history">{{ old('history') }}</textarea>
            ...
            <div class="mt-4">
                ...
                <textarea id="likes" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="likes">{{ old('likes') }}</textarea>
            ...
            <div class="mt-4">
                ...
                <textarea id="dislikes" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="dislikes">{{ old('dislikes') }}</textarea>
            ...
            <div class="mt-4">
                ...
                <label for="is_archived" class="inline-flex items-center">
                    <input id="is_archived" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_archived" value="1" @checked(old('is_archived'))>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="archived_date" class="block mt-1 w-full" type="date" name="archived_date" :value="old('archived_date')" />
            ...
            <div class="mt-4">
                ...
                <textarea id="archive_cause" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="archive_cause">{{ old('archive_cause') }}</textarea>
            ...
            <div class="mt-4">
                ...
                <select id="shelter_id" name="shelter_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
